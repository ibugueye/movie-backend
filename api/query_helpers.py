...
def get_movies(db: Session, skip: int = 0, limit: int = 100, title: str = None, genre: str = None): # type: ignore
...
# --- Évaluations ---
def get_rating(db: Session, movie_id: int ,user_id: int, ):
...
def get_ratings(db: Session, skip: int = 0, limit: int = 100, movie_id: int = None, user_id: int = None, min_rating: float = None): # type: ignore
